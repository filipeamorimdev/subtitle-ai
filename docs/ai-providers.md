...
Translation, routing, ranking, and the Dashboard AI reports depend on generic types (`AIModel`, `AIResponse`, `AIProvider`). HTTP details, auth headers, `:batch` support, and OpenRouter JSON stay inside the adapter.
